import { Imobile } from "../model/mobileInterface";
...
export let mobileProducts : Array<Imobile>  = [
    {
      ...
      isAvailable: true,
      rating : 4.9,
      details : ['8 GB RAM | 128 GB ROM', '16.51 cm (6.5 inch) HD+ Display', '50MP + 2MP | 16MP Front Camera', '5000 mAh Battery', 'Snapdragon 695', ' 5G Processor', 'Vegan Leather Design']
    },
    {
      id: 2,
